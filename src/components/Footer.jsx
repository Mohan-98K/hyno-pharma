      ...
      <div className="footer-container">
        <div className="footer-section">
          ...
          <div className="social-links">
            <button className="social-link" aria-label="Facebook"><FaFacebook /></button>
            <button className="social-link" aria-label="Twitter"><FaTwitter /></button>
            <button className="social-link" aria-label="Instagram"><FaInstagram /></button>
            <button className="social-link" aria-label="LinkedIn"><FaLinkedin /></button>
          </div>
        </div>
